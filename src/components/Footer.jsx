...
const Footer = () => {
  return (
    <footer className='mb-4'>
        ...
        <div className='flex flex-wrap justify-between gap-2 '>
          <div className='max-w-sm'>
            ...
            <Link to={'/'} className='flex items-center justify-start flex-1'>
              <img src={logo} alt="" height={36} width={36} className='hidden mr-2 sm:flex' />
      ...
      {/* copyrights */}
      <p className='px-8 py-2 text-white rounded bg-tertiary medium-14 flexBetween '><span>2026 Bacala</span><span>All rights reserved</span></p>
    </footer>
  )
}
